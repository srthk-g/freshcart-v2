...
function initializeDb(database: Database) {
  ...
  if (count === 0) {
    const products = [
      ...
      ['Green Grapes', 'Seedless green grapes, great for salads', 160, 30, 'Fruits', 'https://images.unsplash.com/photo-1537640538966-79f369143f8f?w=400&h=300&fit=crop'],
      ...
      ['Mangoes', 'Alphonso mangoes - premium quality', 350, 12, 'Fruits', 'https://images.unsplash.com/photo-1553279768-865429fa0078?w=400&h=300&fit=crop'],
      ...
      ['Broccoli', 'Fresh green broccoli florets - 400g', 85, 20, 'Vegetables', 'https://images.unsplash.com/photo-1459411552884-841db9b3cc2a?w=400&h=300&fit=crop'],
      ...
      ['Green Chillies', 'Spicy green chillies - 100g', 15, 60, 'Vegetables', 'https://images.unsplash.com/photo-1588252303782-cb80119abd6d?w=400&h=300&fit=crop'],
      ...
      ['Greek Yogurt', 'Creamy probiotic Greek yogurt - 400g', 120, 20, 'Dairy', 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=400&h=300&fit=crop'],
      ...
      ['Paneer', 'Fresh cottage cheese paneer - 200g', 90, 25, 'Dairy', 'https://images.unsplash.com/photo-1631452180519-c014fe946bc7?w=400&h=300&fit=crop'],
      ...
      ['Green Tea', 'Premium Japanese green tea - 25 bags', 260, 30, 'Beverages', 'https://images.unsplash.com/photo-1556881286-fc6915169721?w=400&h=300&fit=crop'],
      ...
      ['Coconut Water', 'Fresh tender coconut water - 1L', 80, 25, 'Beverages', 'https://images.unsplash.com/photo-1536657464919-892534f60d6e?w=400&h=300&fit=crop'],
      ...
      ['Dark Chocolate', '70% cocoa dark chocolate bar', 180, 0, 'Snacks', 'https://images.unsplash.com/photo-1481391319762-47dff72954d9?w=400&h=300&fit=crop'],
      ['Potato Chips', 'Classic salted potato chips - 150g', 60, 45, 'Snacks', 'https://images.unsplash.com/photo-1566478989037-eec170784d0b?w=400&h=300&fit=crop'],
      ...
      ['Trail Mix', 'Energy trail mix with seeds and berries', 220, 18, 'Snacks', 'https://images.unsplash.com/photo-1604068549290-dea0e4a305ca?w=400&h=300&fit=crop'],
      ...
      ['Sugar', 'White crystal sugar - 1kg', 48, 50, 'Essentials', 'https://images.unsplash.com/photo-1558642452-9d2a7deb7f62?w=400&h=300&fit=crop'],
      ['Salt', 'Iodized table salt - 1kg', 22, 60, 'Essentials', 'https://images.unsplash.com/photo-1518110925495-5fe2fda0442c?w=400&h=300&fit=crop'],
